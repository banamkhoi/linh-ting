...
local Tabs = {
    Info = Window:MakeTab({ Title = "Tab Status Sever",
    Main = Window:MakeTab({ Title = "Tab Farming",
    Settings = Window:MakeTab({ Title = "Tab Setting",
    Fish = Window:MakeTab({ Title = "Tab Fishing",
    Quests = Window:MakeTab({ Title = "Tab Quest And Item",
    SeaEvent = Window:MakeTab({ Title = "Tab Sea Event",
    Race = Window:MakeTab({ Title = "Tab Mirage And Race",
    Prehistoric = Window:MakeTab({ Title = "Tab Volcano Event",
    Esp = Window:MakeTab({ Title = "Tab Stats And Esp",
    Raids = Window:MakeTab({ Title = "Tab Fruit And Raid",
    Combat = Window:MakeTab({ Title = "Tab Local Player",
    Travel = Window:MakeTab({ Title = "Tab Teleport",
    Shop = Window:MakeTab({ Title = "Tab Shopping",
    Misc = Window:MakeTab({ Title = "Tab Miscellaneous",
}
